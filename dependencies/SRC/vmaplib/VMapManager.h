    ...
    class VMapManager : public VMapManagerExt
    {
        ...
        public:
            ...
            */
            ...
            unsigned int getWMOData(unsigned int pMapId, float x, float y, float z, unsigned int &wmoFlags, unsigned int &areaResultFlags, unsigned int& adtFlags, int& adtId, int& rootId, int& groupId, float &groundHeight, unsigned short &liquidFlags, float &liquidHeight, DataPointCallback* callback) const;
