...
bool Rehash()
{
    ...
    {
        sLog.Error( "Config", ">> ronin-logonserver.ini" );
        return false;
    }
    sLog.Success( "Config", ">> ronin-logonserver.ini" );
...
#ifdef WIN32
static const char * default_config_file = "./ronin-logonserver.ini";
#else
static const char * default_config_file = (char*)CONFDIR "/ronin-logonserver.ini";
#endif
