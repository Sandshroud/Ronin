...
{
    RegisterCtrAIScript(26421, WoodlandWalker);
    RegisterCtrGossipScript(26421, WoodlandWalkerGossip);

    RegisterQuestScript(12499, WrathGateQuestCinema);
    RegisterQuestScript(12500, WrathGateQuestCinema);

    RegisterCtrGossipScript(CN_TOP, WyrmrestTemple_FlightGossip);       // Torastrasza <Majordomo to the Ruling Council>
    RegisterCtrGossipScript(CN_MIDDLE, WyrmrestTemple_FlightGossip);    // Lord Afrasastrasz <Commander of Wyrmrest Temple Defenses>
    RegisterCtrGossipScript(CN_BOTTOM, WyrmrestTemple_FlightGossip);    // Tariolstrasz <Steward of Wyrmrest Temple>
}
