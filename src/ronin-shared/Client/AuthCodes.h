...
enum LoginErrorCode
{
    ...
    CHAR_DELETE_FAILED_HAS_HEIRLOOM_OR_MAIL                     = 0x4C,

    CHAR_LOGIN_IN_PROGRESS                                      = 0x4D,
    CHAR_LOGIN_SUCCESS                                          = 0x4E,
    CHAR_LOGIN_NO_WORLD                                         = 0x4F,
    CHAR_LOGIN_DUPLICATE_CHARACTER                              = 0x50,
    CHAR_LOGIN_NO_INSTANCES                                     = 0x51,
    CHAR_LOGIN_FAILED                                           = 0x52,
    CHAR_LOGIN_DISABLED                                         = 0x53,
    CHAR_LOGIN_NO_CHARACTER                                     = 0x54,
    CHAR_LOGIN_LOCKED_FOR_TRANSFER                              = 0x55,
    CHAR_LOGIN_LOCKED_BY_BILLING                                = 0x56,
    CHAR_LOGIN_LOCKED_BY_MOBILE_AH                              = 0x57,
    CHAR_LOGIN_TEMPORARY_GM_LOCK                                = 0x58,

    CHAR_NAME_SUCCESS                                           = 0x59,
    CHAR_NAME_FAILURE                                           = 0x5A,
    CHAR_NAME_NO_NAME                                           = 0x5B,
    CHAR_NAME_TOO_SHORT                                         = 0x5C,
    CHAR_NAME_TOO_LONG                                          = 0x5D,
    CHAR_NAME_INVALID_CHARACTER                                 = 0x5E,
    CHAR_NAME_MIXED_LANGUAGES                                   = 0x5F,
    CHAR_NAME_PROFANE                                           = 0x60,
    CHAR_NAME_RESERVED                                          = 0x61,
    CHAR_NAME_INVALID_APOSTROPHE                                = 0x62,
    CHAR_NAME_MULTIPLE_APOSTROPHES                              = 0x63,
    CHAR_NAME_THREE_CONSECUTIVE                                 = 0x64,
    CHAR_NAME_INVALID_SPACE                                     = 0x65,
    CHAR_NAME_CONSECUTIVE_SPACES                                = 0x66,
    CHAR_NAME_RUSSIAN_CONSECUTIVE_SILENT_CHARACTERS             = 0x67,
    CHAR_NAME_RUSSIAN_SILENT_CHARACTER_AT_BEGINNING_OR_END      = 0x68,
    CHAR_NAME_DECLENSION_DOESNT_MATCH_BASE_NAME                 = 0x69
};
