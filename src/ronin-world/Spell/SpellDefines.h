...
enum SpellImplicitTargetType
{
    ...
    SPELL_TARGET_USE_INFO               = 0x10000000,

    SPELL_TARGET_AREA_MASK              = SPELL_TARGET_AREA | SPELL_TARGET_AREA_SELF | SPELL_TARGET_AREA_CONE | SPELL_TARGET_AREA_CHAIN
                                        | SPELL_TARGET_AREA_CURTARGET | SPELL_TARGET_AREA_RANDOM | SPELL_TARGET_AREA_PARTY | SPELL_TARGET_AREA_RAID,
};
