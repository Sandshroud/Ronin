...
{
public:
    SpellEffectClass(WorldObject* caster, SpellEntry *info);
    ~SpellEffectClass();
...
protected: // Effect Handlers
    ...
    // Summons
    void SummonWild(Unit *u_caster, uint32 i, SummonPropertiesEntry* spe, CreatureData* proto, LocationVector & v);
    void SummonTotem(Unit *u_caster, uint32 i, SummonPropertiesEntry* spe, CreatureData* proto, LocationVector & v);
    void SummonGuardian(Unit *u_caster, uint32 i, SummonPropertiesEntry* spe, CreatureData* proto, LocationVector & v);
    void SummonTemporaryPet(Unit *u_caster, uint32 i, SummonPropertiesEntry* spe, CreatureData* proto, LocationVector & v);
    void SummonPossessed(Unit *u_caster, uint32 i, SummonPropertiesEntry* spe, CreatureData* proto, LocationVector & v);
    void SummonCompanion(Unit *u_caster, uint32 i, SummonPropertiesEntry* spe, CreatureData* proto, LocationVector & v);
    void SummonVehicle(Unit *u_caster, uint32 i, SummonPropertiesEntry *spe, CreatureData *proto, LocationVector &v);
};
