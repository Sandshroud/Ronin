...
public:
    ...
    /* Packet Handlers */
    void HandleBattlegroundListPacket(WorldSession * m_session, uint32 BattlegroundType, WoWGuid requestguid = WoWGuid(0));
...
public:
    ...
    RONIN_INLINE bool IsArena() { return (m_type >= BATTLEGROUND_ARENA_2V2 && m_type <= BATTLEGROUND_ARENA_5V5); }
...
public:
    ...
    /* Has it ended? */
    RONIN_INLINE bool HasEnded() { return m_ended; }
    RONIN_INLINE bool HasStarted() { return m_started; }
    ...
    /* Full? */
    RONIN_INLINE bool IsFull() { return !(HasFreeSlots(0) || HasFreeSlots(1)); }
    ...
    RONIN_INLINE uint32 GetStartTime() { return m_startTime; }
    RONIN_INLINE uint32 GetType() { return m_type; }
    ...
    RONIN_INLINE uint32 GetLastResurrect() { return m_lastResurrect; }
