...
public:
    ...
    bool m_announce;
    uint32 m_team;
    RONIN_INLINE size_t GetNumMembers() { return m_members.size(); }
...
public:
    ...
    RONIN_INLINE Player* Grab() { return m_itr->first; }
    RONIN_INLINE bool End() { return (m_itr==m_endItr)?true:false; }
};
