...
public:
    ...
    ********/
    ...
    RONIN_INLINE void RefreshAura(SpellEntry *sp, WoWGuid guid) { m_AuraInterface.RefreshAura(sp, guid); }
    RONIN_INLINE void AddAuraStack(SpellEntry *sp, WoWGuid guid) { m_AuraInterface.RefreshAura(sp, guid, true); }
