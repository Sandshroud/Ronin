...
enum ItemStatType : unsigned
{
    ...
    ITEM_STAT_MELEE_HIT_REDUCTION_RATING      = 22,
    ITEM_STAT_RANGED_HIT_REDUCTION_RATING     = 23,
    ITEM_STAT_SPELL_HIT_REDUCTION_RATING      = 24,
    ITEM_STAT_MELEE_CRITICAL_REDUCTION_RATING = 25,
    ITEM_STAT_RANGED_CRITICAL_REDUCTION_RATING= 26,
    ITEM_STAT_SPELL_CRITICAL_REDUCTION_RATING = 27,
